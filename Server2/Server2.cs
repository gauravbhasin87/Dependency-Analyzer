...
namespace Server2
{
    class RelationCommunicator2 : AbstractCommunicator
    {
        ...
        public string convertListtoXml(List<ElemForRel> list)
        {
            string xml;
            //int i = 0;
            //foreach (Repository<Elem> rep in repoArray)
        ...
        protected override void ProcessMessages()
        {
            ...
            while (true)
            {
                ...
                {
                    Console.WriteLine("TypeTable from Server1 Received");
                ...
                if (i == 3)
                {
                    ...
                    //ServiceMessage reply3 = ServiceMessage.MakeMessage("client-echo", "relAnalyzer", "", Array: xml, resName: "TypeTablefromServer2");
                    ...
                    //DisplayRepository.displayRelationAnalysis(repForRel, true);
                    ...
                    ServiceMessage reply4 = ServiceMessage.MakeMessage("client-echo", "relAnalyzer", content, resName: "RelationsTablefromServer2");
    ...
    class TypeAnalysisCommunicator2 : AbstractCommunicator
    {
        ...
        protected override void ProcessMessages()
        {
            while (true)
            {
                ...
                ServiceMessage reply = ServiceMessage.MakeMessage("relAnalyzer", "typAnalyzer", msg.Contents, Array: xml, resName: "TypeTablefromServer2");
                reply.TargetUrl = "http://localhost:8000/CommService";
                reply.SourceUrl = msg.TargetUrl;
                AbstractMessageDispatcher dispatcher = AbstractMessageDispatcher.GetInstance();
                dispatcher.PostMessage(reply);

                //post message to relAnalyzerCommunicator
                ServiceMessage reply2 = ServiceMessage.MakeMessage("relAnalyzer", "typAnalyzer", "", Array: xml, resName: "TypeTablefromServer2");
    ...
    class EchoCommunicator2 : AbstractCommunicator
    {
        protected override void ProcessMessages()
        {
            while (true)
    ...
    class QueryCommunicator2 : AbstractCommunicator
    {
        protected override void ProcessMessages()
        {
            while (true)
    ...
    class NavigationCommunicator2 : AbstractCommunicator
    {
    ...
    class Server2
    {
        static void Main(string[] args)
        {
            ...
            string ServerUrl = "http://localhost:8002/CommService";
            ...
            EchoCommunicator2 echo = new EchoCommunicator2();
            echo.Name = "echo";
            ...
            QueryCommunicator2 query = new QueryCommunicator2();
            query.Name = "query";
            ...
            NavigationCommunicator2 nav = new NavigationCommunicator2();
            nav.Name = "nav";
            receiver.Register(nav);
            nav.Start();

            TypeAnalysisCommunicator2 typAnalyzer = new TypeAnalysisCommunicator2();
            typAnalyzer.Name = "typAnalyzer";
            receiver.Register(typAnalyzer);
            typAnalyzer.Start();

            RelationCommunicator2 relAnalyzer = new RelationCommunicator2();
            ...
            ServiceMessage toTypCom = ServiceMessage.MakeMessage("typAnalyzer", "Server2", "");
